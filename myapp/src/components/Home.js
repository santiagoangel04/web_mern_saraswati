...
const Home = () => {
    ...
    return (
        <main className='flex-1'>
            <nav className="bg-sky-300 border-sky-300 px-2 sm:px-4 py-2.5 rounded-lg dark:bg-gray-900">
            <div className="container flex flex-wrap items-center justify-between mx-auto">
                ...
                <div className="hidden w-full md:block md:w-auto" id="navbar-default">
                    <ul className="flex flex-col p-4 mt-4 border border-sky-300 rounded-lg bg-sky-300 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-sky-300 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        ...
                        <li>
                        <a href='/Login' className="block py-2 pl-3 pr-4text -white bg-green-700 px-4  text-white uppercase font-bold text-sm rounded-lg" aria-current="page">LOG IN </a>
                        </li>
                        </ul>
                </div>
            </div>    
        ...
        <div className="flex-1 bg-sky-200">
           <div className="py-16 sm:py-24 xl:mx-auto xl:max-w-7xl xl:px-8">
             <div className="px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8 xl:px-0">
               ...
               <a href="#" className="hidden text-sm font-semibold text-stone-800 hover:text-stone-500 sm:block">
